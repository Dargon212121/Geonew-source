...
void SaveCFG(const char* FileName)
{
    ...
    char Path[0x100];
    sprintf(Path, "C:\\geonew\\");

    if (!folder_exists(Path))
        _mkdir(Path);
    cfg.SetUnicode();
    char result[0x100];
    sprintf(result, "C:\\geonew\\%s.ini", FileName);
...
#pragma region Player Color
    ...
    SaveColorValue("Player", "Fov", ColorsNShit::Fov);
    SaveColorValue("Player", "Name", ColorsNShit::NameColor);
    SaveColorValue("Player", "BoxColor", ColorsNShit::BoxColor);
    SaveColorValue("Player", "DistanceColor", ColorsNShit::DistanceColor);
    SaveColorValue("Player", "PlayerHeath", ColorsNShit::PlayerHeath);
    SaveColorValue("Player", "WeaponColor", ColorsNShit::WeaponColor);
    SaveColorValue("Player", "LineEsp", ColorsNShit::LineEsp);
    SaveColorValue("Player", "SkeletonColor", ColorsNShit::SkeletonColor);
    SaveColorValue("Player", "Wounded", ColorsNShit::Wounded);
    SaveColorValue("Player", "Target_text", ColorsNShit::Target_text);
    SaveColorValue("Player", "Textesp", ColorsNShit::Textesp);
    SaveColorValue("Player", "Crosshair", ColorsNShit::Crosshair2);
    SaveColorValue("Player", "Fonts", ColorsNShit::Fonts);
    SaveColorValue("Player", "TextColor", ColorsNShit::TextColor);
    SaveColorValue("Player", "TextColor2", ColorsNShit::TextColor2);
...
void LoadCFG(const char* FileName)
{
    ...
    char Path[0x100];
    sprintf(Path, "C:\\{%lu}\\", SerialNumber);

    if (!folder_exists(Path))
        _mkdir(Path);
    cfg.SetUnicode();
    char result[0x100];
    sprintf(result, "C:\\{%lu}\\%s.ini", SerialNumber, FileName);
    cfg.LoadFile(result);
...
#pragma region Player Color
    //  SaveColorValue("Player", "Name", Color::NameColor);
    LoadColorValue("Player", "Fov", ColorsNShit::Fov);
    LoadColorValue("Player", "Name", ColorsNShit::NameColor);
    LoadColorValue("Player", "BoxColor", ColorsNShit::BoxColor);
    LoadColorValue("Player", "DistanceColor", ColorsNShit::DistanceColor);
    LoadColorValue("Player", "PlayerHeath", ColorsNShit::PlayerHeath);
    LoadColorValue("Player", "WeaponColor", ColorsNShit::WeaponColor);
    LoadColorValue("Player", "SkeletonColor", ColorsNShit::SkeletonColor);
    LoadColorValue("Player", "LineEsp", ColorsNShit::LineEsp);
    LoadColorValue("Player", "Wounded", ColorsNShit::Wounded);
    LoadColorValue("Player", "Target_text", ColorsNShit::Target_text);
    LoadColorValue("Player", "Textesp", ColorsNShit::Textesp);
    LoadColorValue("Player", "Crosshair", ColorsNShit::Crosshair2);
    LoadColorValue("Player", "Fonts", ColorsNShit::Fonts);
    LoadColorValue("Player", "TextColor", ColorsNShit::TextColor);
    LoadColorValue("Player", "TextColor2", ColorsNShit::TextColor2);
    /*SaveColorValue("Player - Color", "Player Fill Box Color", Bools::PlayerColor::PlayerFillBoxColor);
    SaveColorValue("Player - Color", "Player Dead Color", Bools::PlayerColor::PlayerDeadColor);
    SaveColorValue("Player - Color", "Player Backpack Color", Bools::PlayerColor::PlayerBackpackColor);*/
#pragma endregion
