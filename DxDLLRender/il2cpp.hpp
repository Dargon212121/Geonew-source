...
namespace il2cpp {
	...
	uintptr_t method(const char* kl, const char* name, int argument_number = -1, char* arg_name = (""), const char* name_space = (""), int selected_argument = -1) {
		uintptr_t iter = 0;
		uintptr_t f;
	...
	uintptr_t hook(void* our_func, const char* function_to_hook, const char* class_to_hook, const char* name_space = (""), int argument_number = -1, char* argument_name = ("")) {
